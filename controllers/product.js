...
// create product by admin/manufacturer
    ...
    try {
        if (!req.body.name) {
            ...
            pool.getConnection(function (err, connection) {
                ...
                call iot.new_product_post('${req.body.name}', '${req.body.description}', '${req.body.quantity}', '${JSON.stringify(req.body.configurations)}',@_returnValue);
                select @_returnValue;`
